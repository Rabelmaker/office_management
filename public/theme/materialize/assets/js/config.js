 ...
 * defaultHeaderType: 'static', 'fixed' (for horizontal layouts only)
 * defaultMenuCollapsed: true, false (For vertical layouts only)
 * defaultNavbarType: 'sticky', 'static', 'hidden' (For vertical layouts only)
 * defaultFooterFixed: true, false (For vertical layouts only)
 * defaultShowDropdownOnHover : true, false (for horizontal layouts only)
 */
