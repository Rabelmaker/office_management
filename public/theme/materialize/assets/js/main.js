...
if (document.getElementById('layouts-menu')) {
  isHorizontalLayout = document.getElementById('layouts-menu').classList.contains('menu-horizontal');
}
...
(function () {
  ...
  function onScroll() {
    var layoutPage = document.querySelector('.layouts-page');
    if (layoutPage) {
  ...
  window.Helpers.swipeOut('#layouts-menu', function (e) {
  ...
  // if (isRtl) {
  //   Helpers._addClass('dropdown-menu-end', document.querySelectorAll('#layouts-navbar .dropdown-menu'));
  // }
    ...
    function (event) {
      ...
      if (horizontalMenuTemplate) {
        ...
        setTimeout(function () {
          if (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT) {
            if (document.getElementById('layouts-menu')) {
              if (document.getElementById('layouts-menu').classList.contains('menu-horizontal')) {
                menu.switchMenu('vertical');
              }
            }
          } else {
            if (document.getElementById('layouts-menu')) {
              if (document.getElementById('layouts-menu').classList.contains('menu-vertical')) {
...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      // Search JSON
      var searchJson = 'search-vertical.json'; // For vertical layouts
      if ($('#layouts-menu').hasClass('menu-horizontal')) {
        var searchJson = 'search-horizontal.json'; // For vertical layouts
      }
