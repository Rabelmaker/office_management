...
(function () {
  const layoutMenu1 = document.querySelector('#layouts-menu1'),
    layoutMenu2 = document.querySelector('#layouts-menu2'),
    layoutMenu3 = document.querySelector('#layouts-menu3'),
    layoutMenu4 = document.querySelector('#layouts-menu4');
