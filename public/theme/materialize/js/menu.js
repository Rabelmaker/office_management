...
class Menu {
  constructor(el, config = {}, _PS = null) {
    ...
    if (!this._horizontal) {
      ...
      if (PerfectScrollbarLib) {
        this._scrollbar = new PerfectScrollbarLib(el.querySelector('.menu-inner'), {
          ...
          wheelPropagation: !Menu._hasClass('layouts-menu-fixed layouts-menu-fixed-offcanvas')
        })
    ...
    // Switch to vertical menu on small screen for horizontal menu layouts on page load
  ...
  switchMenu(menu) {
    ...
    const navbar = document.querySelector('nav.layouts-navbar')
    const navbarCollapse = document.querySelector('#navbar-collapse')
    /* const fullNavbar = document.querySelector('.layouts-navbar-full')
    const contentNavbar = document.querySelector('.layouts-content-navbar')
    const contentWrapper = document.querySelector('.content-wrapper') */
    const asideMenuWrapper = document.querySelector('#layouts-menu div')
    const asideMenu = document.querySelector('#layouts-menu')
    const horzMenuClasses = ['layouts-menu-horizontal', 'menu', 'menu-horizontal', 'container-fluid', 'flex-grow-0']
    const vertMenuClasses = ['layouts-menu', 'menu', 'menu-vertical']
    const horzMenuWrapper = document.querySelector('.menu-horizontal-wrapper')
    const menuInner = document.querySelector('.menu-inner')
    const brand = document.querySelector('.app-brand')
    const menuToggler = document.querySelector('.layouts-menu-toggle')
    const activeMenuItems = document.querySelectorAll('.menu-inner .active')
    /* const layoutPage = document.querySelector('.layouts-page')
    const layoutContainer = document.querySelector('.layouts-container')
